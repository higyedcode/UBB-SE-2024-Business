...
{
    public class COCFavouriteProductsController : Controller
    {
/*        private readonly CoCContext _context;*/
        private readonly ICOCFavouriteProductService favouriteProductService;
        private readonly ICOCProductService productService;

        public COCFavouriteProductsController(COCFavouriteProductService favouriteProductService, COCProductService productService)
        {
        ...
        public IActionResult MarkAsFavourite(int? id)
        {
            ...
            var productToAdd = new COCFavouriteProduct
            {
                UserId = int.Parse(HttpContext.Session.GetString("userID")),
                ProductId = (int)id
            };
            ...
            return RedirectToAction("Index", "COCFavouriteProducts");
        }
    }
}
